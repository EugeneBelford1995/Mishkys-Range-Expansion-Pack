...
Set-DNSClientServerAddress -InterfaceAlias $NIC -ServerAddresses ("$NetworkPortion.145", "$NetworkPortion.141", "$NetworkPortion.140", "1.1.1.1", "8.8.8.8")
